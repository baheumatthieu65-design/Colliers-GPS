    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-900/40 backdrop-blur-sm">
      <div className="bg-white border border-[#E2E6DF] text-[#2C3327] rounded-2xl w-full max-w-lg p-6 shadow-xl relative">
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-5">
          ...
          <div className="bg-[#FDF0E2] border border-[#FAD7B2] p-3.5 rounded-xl text-xs"><div className="font-bold flex items-center space-x-1 text-[#E67E22]"><CheckCircle2 className="w-4 h-4" /><span>Action immédiate</span></div><p className="text-[11px] leading-relaxed mt-1">Le collier transmettra sa position GPS toutes les <strong>{intervalSeconds/60} min</strong> pendant <strong>{durationMinutes} min</strong>, puis reviendra automatiquement à la cadence standard.</p></div>
